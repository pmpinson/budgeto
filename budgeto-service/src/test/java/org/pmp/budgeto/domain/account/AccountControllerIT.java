...
public class AccountControllerIT {
    ...
    public void operations() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$[?(@.label=='operation 1')].date").value("2015/02/26 18:12:13"))
                .andExpect(MockMvcResultMatchers.jsonPath("$[?(@.label=='ope2')].label").value("ope2"))
                .andExpect(MockMvcResultMatchers.jsonPath("$[?(@.label=='ope2')].date").value("2015/02/27 19:12:13"));
    }
