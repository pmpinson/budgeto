 ...
 */
@RestController
@RequestMapping(value = "account", produces = DefaultControllerAdvice.JSON_CONTENT_TYPE)
...
public class AccountController {
    ...
    @ApiOperation(value = "Retrieve all accounts (note de test)", notes = "No")
    @ApiResponses({
    ...
    @RequestMapping(value = "", method = RequestMethod.POST, consumes = DefaultControllerAdvice.JSON_CONTENT_TYPE)
